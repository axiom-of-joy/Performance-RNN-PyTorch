...
# Registered "hooks" for monitoring functions in model.
distiller.utils.assign_layer_fq_names(model)
# Skipped msglogger line.
collector = distiller.data_loggers.QuantCalibrationStatsCollector(model)
with distiller.data_loggers.collector_context(collector):
    if init_zero:
